...
const logo_alt_text = "Das Brettspielsonntag-Logo: Eine Gruppe verschiedenster Wesen sitzt um ein Lagerfeuer herum: Darth Vader, Deadpool, ein Baby-C'Thulhu, eine Maus und ein paar Meeple.";
